...
public class BrowserUtils {
	...
	public String textOfSearchCriteria() {
		amazonPage = new amazonSearchPage();
		String searchCriteriaText = amazonPage.searchResult.getText();
		String searchCriteriaTrimed = searchCriteriaText.substring(1, searchCriteriaText.length()-1);
		return searchCriteriaTrimed;
	}
