...
//		loginpage.passwordField.sendKeys(DataReader.getProperty("password"));
	...
	public void i_should_see_an_error_message() {
		if ("invalid@primetechschool.com".equals(emailAddress) && "password".equals(passwordInput) 
				|| "username".equals(emailAddress) && "helloWorld123".equals(passwordInput)) {
			
			utils.waitUntilElementVisible(loginpage.ErrorMessage);
